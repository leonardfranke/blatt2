...
public class StringStack {
	...
	/**
	 * Constructor which creates a deep copy of another StringStack
	 * @param ss	StringStack which is to copy
	 *
	 */
	public StringStack(StringStack ss) {
		StringStack helpStack = new StringStack();
		while(!ss.empty()) {
			helpStack.push(ss.pop());
		}
		while(!helpStack.empty()) {
			String str = new String(helpStack.peek());
			this.push(str);
			ss.push(helpStack.pop());
		}
	}
